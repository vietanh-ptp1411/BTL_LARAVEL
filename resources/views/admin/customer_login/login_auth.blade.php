...
<div class="user-wrapper">
    <div class="user-nav anonymous-awe">
        <a href="{{route('login_auth')}}" class="active" rel="nofollow">Đăng nhập</a>
        <a href="{{route('register_auth')}}" class="active1" rel="nofollow">Đăng ký</a>
    </div>
    ...
    @endif                             
    <form action="{{route('loginAdmin')}}" accept-charset="UTF-8" id="formAcount" class="validate" method="post">
    {{csrf_field()}}
        <div style="margin-bottom: 1rem ">
            <input type="text" name="email"  placeholder="Nhập email hoặc tên đăng nhập">
        </div>
        <div style="margin-bottom: 1rem ">
        ...
        <div class="user-foot text-center">
            ...
            <div class="qmk-dktk">
                ...
                <a href="{{route('register_auth')}}" class="quenmk" rel="nofollow">Đăng ký tài khoản</a>
            </div>
