                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            <tbody>
                                ...
                                <tr>
                                    <td>Ảnh sản phẩm:</td>
                                    <td>
                                        <input style="width:400px" type='file' name='ProImage' id='ProImage'
                                            accept="DoAn3_IMG/*">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Ảnh chi tiết:</td>
                                    <td>
                                        <input style="width:500px" type='file' name='MoreImage1' id='MoreImage1'
                                            accept="DoAn3_IMG/*" multiple>
                                        <input style="width:500px" type='file' name='MoreImage2' id='MoreImage2'
                                            accept="DoAn3_IMG/*" multiple>
                                        <input style="width:500px" type='file' name='MoreImage3' id='MoreImage3'
                                            accept="DoAn3_IMG/*" multiple>
                                    </td>
                                </tr>
                                <tr>
